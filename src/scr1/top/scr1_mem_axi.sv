...
#(
    ...
    parameter SCR1_AXI_RID_VALUE    = 0,
    parameter SCR1_AXI_WID_VALUE    = 0
)
(
    // Clock and Reset
    input   logic                           clk,
...
assign awid     = SCR1_AXI_IDWIDTH'(SCR1_AXI_WID_VALUE);
assign awlen    = 8'd0;
...
assign arid     = SCR1_AXI_IDWIDTH'(SCR1_AXI_RID_VALUE);
assign arlen    = 8'd0;
