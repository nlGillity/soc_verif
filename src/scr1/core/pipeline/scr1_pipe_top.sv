...
always @(posedge clk, negedge pipe_rst_n) begin
  if (~pipe_rst_n) begin
    instr <= '0;
  end else if (i_pipe_ifu.ifu2idu_vd_o && i_pipe_ifu.idu2ifu_rdy_i) begin
    instr <= i_pipe_ifu.ifu2idu_instr_o;
  end
end
